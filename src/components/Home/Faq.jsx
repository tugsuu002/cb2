      ...
      {faq.map((e) => {
        return (
          <ul
            ...
            className="rounded-[14px] w-[90%] lg:w-[70%] max-w-[564px] my-4 pt-1 drop-shadow-md bg-[#171C1F] text-white md:mx-auto md:w-4/5 hover:-translate-y-1 hover:shadow-xl transition ease-in-out delay-150 borderduration-300"
            >
            <li className="flex p-6 justify-between">
              ...
              />
              {checkedState[e.id] ? (
                <MdHorizontalRule color="#E91E63" size={20} />
              ) : (
                <MdAdd color="#E91E63" size={20} />
              )}
            </li>
            {checkedState[e.id] && (
              <div className="">
