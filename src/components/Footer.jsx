    ...
    <>
      <div className=" text-white flex flex-col justify-between bg-black ">
        <div className="mx-auto w-full max-w-[1320px] px-4  sm:px-2 lg:px-1  py-8 lg:py-16">
          <div
            className="relative w-full h-auto lg:h-[352px] rounded-[20px] flex flex-col justify-items-center lg:flex-row items-center justify-between text-center text-white [background:radial-gradient(circle_at_top_left,_rgba(255,255,255,0.1)_25%,_rgba(255,255,255,0)_50%),radial-gradient(circle_at_bottom_right,_rgba(255,255,255,0.1)_16%,_rgba(255,255,255,0)_75%),radial-gradient(ellipse_at_center,_rgba(0,0,0,0.45)_100%,_rgba(0,0,0,0.75)_100%)]"
          >
            <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start px-4 lg:px-0 pt-12 lg:pl-20 z-10  justify-start text-center lg:text-left">
              <p className=" text-[40px] md:text-[64px] font-pro font-semibold  text-[#FFFFFF]">
                {t("chatbotTest")}
              </p>

              <p className="text-sm sm:text-base md:text-[17px] font-pro font-normal mb-10 text-[#FFFFFF]">
                {t("chatbotText")}
              </p>
        ...
        <footer className="mx-auto w-full max-w-[1320px] text-gray-300 px-2 lg:px-1 mt-[26px] pb-4">
          <div className="flex flex-col md:flex-row md:space-x-20 space-y-6 md:space-y-0 md:justify-between">
            <div className="flex flex-col justify-between h-auto relative">
              ...
              <div className="flex gap-4 md:absolute bottom-0">
                <a
            ...
            <div className="w-auto lg:w-[290px] md:justify-end flex">
              <div>
            ...
            <div className="w-auto lg:w-[290px]">
              <h4 className="text-white font-pro font-semibold mb-4">
                {t("footer.row4")}
              </h4>
              <div className="max-w-[330px] mt-[29px]">
                <p className="font-variable font-normal text-[16px] leading-relaxed text-transparent bg-clip-text bg-gradient-to-r from-[#D8ECF8] to-[#98C0EF] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)] mb-[30px] max-w-[296px]">
                  {t("footer.address")}
                </p>
                ...
                <div className="flex flex-col gap-3">
                  <a
                    href="tel:77441616"
                    className="flex items-center bg-[#0d0f11] rounded-[20px] p-2 text-[#FFFFFF] text-[16px] font-pro font-medium w-full md:w-[129px] hover:bg-[#1f262a] transition shadow-none hover:shadow-[0_0_16px_rgba(255,255,255,0.35)]"
                  >
                    <img
                      loading="lazy"
                      src={phone}
                      alt="phone"
                      className="w-4 h-4 ml-[14px] mt-1"
                    />
                  ...
                  <a
                    ...
                    className="flex items-center bg-[#0d0f11] p-[8px] rounded-[20px] text-[#FFFFFF] text-[16px] font-pro font-medium w-full md:w-[200px] hover:bg-[#1f262a] transition shadow-none hover:shadow-[0_0_16px_rgba(255,255,255,0.35)]"
                  >
                    <img
                      loading="lazy"
                      src={mail}
                      alt="mail"
                      className="w-4 h-4 ml-[14px] mt-1.5"
                    />
              ...
              <div>
                ...
                >
                  ...
                  <img
                    ...
                    src={arrow}
                    alt="arrow"
                    className="w-2 h-2 md:w-[7px] md:h-[15px] ml-2"
                  />
                </a>
              </div>
              <div className="mt-3">
